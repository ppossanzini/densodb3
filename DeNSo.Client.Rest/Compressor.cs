...
namespace DeNSo
{
  public static class StringCompressor
  {
    ...
    public static Stream GetCompressorStream(this Stream destinationstream)
    {
      if (destinationstream == null)
        throw new ArgumentNullException();
      return new GZipStream(destinationstream, CompressionMode.Compress, true);
    }
    ...
    public static Stream DecompressToStream(this byte[] value)
    {
      if (value != null && value.Length > 0)
      {
